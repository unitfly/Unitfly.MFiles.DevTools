...
{
    public class ServerApplication : BaseServerApplication
    {
        public ServerApplication(LoginType loginType, string vaultName, string username, string password, string domain = null,
